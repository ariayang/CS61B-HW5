...
public class DList extends List {
  ...
  public DList() {
    ...
    //   the `list' field (second parameter) as well.
      DListNode sentinel = newNode(new Object(), null, head, head);
      sentinel.next = sentinel;
      sentinel.prev = sentinel;
      sentinel.myList = null;
      size = 0;
      head = sentinel;
  }
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode a = newNode(item, this, this.head, this.head.next);
    a.next = head.next;
    a.prev = head;
    head.next.prev = a;
    head.next = a;
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode a = newNode(item, this, this.head.prev, this.head);
      a.next = head;
      a.prev = head.prev;
      this.head.prev.next = a;
      this.head.prev = a;
      size++;
  }
  ...
  private static void testEmpty() {
    ...
    System.out.println("l's back is: " + l.back().item);
    System.out.println("l's front is: " + l.front().item);
  }
  ...
  public static void main(String[] argv) {
	...
	i++;
      ...
      i = 6;
      //System.out.println("now i=6. l.back() is: " +l.back().item());
      //In the debug process now, l.back().item is invalid. why?
      //Found it. In insertfront(), I set the head.next.prev after resetting the head.next. Should do it before.
